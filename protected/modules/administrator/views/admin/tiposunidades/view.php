  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
        ...
        <td width="498" align="left"><strong style="border-bottom-style:groove">VISUALIZACIÒN DE REGISTROS [ TIPOSUNIDADES : Detalles ] </strong></td>
...
?>         
        ...
        <td width="80" align="center"><?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('tiposunidades/view','id'=>$model->TIUN_ID),$htmlOptions ); 
?>         
		 </td>
        <td width="80" align="center"><?php
