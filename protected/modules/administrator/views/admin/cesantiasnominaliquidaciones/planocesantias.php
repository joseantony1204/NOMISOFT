...
$Cesantiasnomina = Cesantiasnomina::model()->findByPk($cesantiasNomina);
 ...
 $encabezado=$arc->izquierda("UNIVERSIDAD DE LA GUAJIRA",90).$arc->enter().
             $arc->izquierda("SECCION DE PERSONAL",90).$arc->izquierda("PERIODO      : ".$Cesantiasnomina->CENO_PERIODO."",60).$arc->enter().
	         $arc->izquierda("REPORTE PARA CESANTIAS",90).$arc->izquierda("FECHA PROCESO: ".date("d/m/Y"),60).$arc->enter().
...
//***********************COMENZAR LA CAPTURA DE DATOS***************************************************************//
 ...
 for($i=1;$i<$filas-1;$i++)		 
  ...
  $basico=(($Cesantiasnominaliquidaciones->liquidacion[$i][4]));
