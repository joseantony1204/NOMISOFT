       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE PRIMAVACACIONESNOMINALIQUIDACIONES  [ Actualizar ] </em></span></strong></td>
...
?>         
             ...
             <td width="13%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/primavacacionesnominaliquidaciones/update','id'=>$model->PVNL_ID),$htmlOptions ); 
?>        
					              </td>
           </tr>
        </table>
