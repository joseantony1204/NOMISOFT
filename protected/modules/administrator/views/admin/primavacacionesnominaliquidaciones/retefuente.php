...
$this->breadcrumbs=array(
	...
	'Busqueda'=>array('admin/primavacacionesnomina/search'),
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="84%"><strong><span><em>ADMINISTRACION DE PRIMA DE VACACIONES - REPORTE TERCEROS : ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
...
?>         
             ...
             <td width="10%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/primavacacionesnominaliquidaciones/downretefuente',
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'primavacacionesnomina-grid',
	'dataProvider'=>$Primavacacionesnominaliquidaciones->prestacionesDataProvider,
