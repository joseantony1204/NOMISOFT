       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
			 ...
			 <td width="70%"><strong><span><em>ENVIAR POR CORREO DE LIQUIDACION PRIMA DE VACACIONES ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
		     ...
		     echo CHtml::link($image, array('admin/primavacacionesnomina/search',                                                              
										   ),
							 $htmlOptions 
							);
			?>           
			 ...
			 $image = CHtml::image($imageUrl);
		     echo CHtml::link($image, array('admin/primavacacionesnominaliquidaciones/mail',
...
echo "<h4><font color='#009900'><div align='center'><strong>Se enviaran un total de: ".($filas-2)." correos electronicos.<strong></div></font></h4>";
	...
	*/
	 $filascorreos = $Email->getsNotasemails(4);
...
?>
	...
	if ($Mensualnomina->Personageneral->PEGE_EMAIL=='' or !$Mensualnomina->Personageneral->PEGE_EMAIL){
       $tabla2.=" 
       <td>".$Primavacacionesnominaliquidaciones->liquidacion[$i][14]."</td>
	 ...
	 if ($Primavacacionesnomina->PVNO_ESTADO==0)
		$estado='<strong><font color="#FF0000">Estado:&nbsp;&nbsp;&nbsp;En revisión</font></strong>';
	 elseif($Primavacacionesnomina->PVNO_ESTADO==1)
	 ...
	 <table width="100%" border="1" align="center" CELLSPACING="0" class="tabla2" >
        <tr>
         <th colspan="2" align="center">PRIMA VACACIONES DE EMPLEADOS UNIVERSIDAD DE LA GUAJIRA</th>
        </tr>
        <tr>
        ...
        <tr valign="top">
         <td width="45%">
			...
			<table width="100%" border="1" CELLSPACING="0" class="tabla2">
			  ...
			  <tr>
                ...
                <td width="181">'.$Primavacacionesnominaliquidaciones->liquidacion[$i][13].' - '.$Primavacacionesnominaliquidaciones->liquidacion[$i][1].'</td>
              </tr>
             
			 <tr>
                <td width="87">Periodo Liquidación</td>
                <td width="181">'.$Primavacacionesnomina->PVNO_PERIODO.'</td>
              </tr>
         ...
         <td width="55%" >
		    ...
		    <table width="100%" border="0" class="tabla2" style="border:1px solid;padding:3px 3px; border-color:#000">
              ...
              <tr>
	           <td>SUELDO('.number_format($Primavacacionesnominaliquidaciones->liquidacion[$i][4]).')</td>
			   <td align="center">'.$Primavacacionesnominaliquidaciones->liquidacion[$i][2].'</td>
			   <td align="right">'.number_format($Primavacacionesnominaliquidaciones->liquidacion[$i][5]).'</td>
	           <td>&nbsp;</td>
	           <td>&nbsp;</td>		       
		      </tr>';
			  ...
			  $tabla1 .='
	          <tr>
		       <td>'.$Primavacacionesnominaliquidaciones->liquidacion[0][$ln].'</td>
		       <td align="center">'.$antig.'</td>
		       <td align="right">'.number_format($Primavacacionesnominaliquidaciones->liquidacion[$i][$ln]).'</td>
		       <td>&nbsp;</td>
		       <td>&nbsp;</td>		       
		      </tr>';
			  ...
			  $tabla1.='
			  <tr>
		       <td>'.$Primavacacionesnominaliquidaciones->parafiscales[0][$ln].'</td>
		       <td align="center">&nbsp;</td>
		       <td>&nbsp;</td>
			   <td align="right">'.number_format($Primavacacionesnominaliquidaciones->parafiscales[$i][$ln]).'</td>
		       <td>&nbsp;</td>		       
		      </tr>';
	          ...
	          <tr>
	           ...
	           <td align="right" style="border-top:1px solid;padding:3px 3px;border-color:#000">'.number_format($Primavacacionesnominaliquidaciones->liquidacion[$i][$columnas-1]).'</td>
	           <td align="right" style="border-top:1px solid;padding:3px 3px;border-color:#000">'.number_format(($Primavacacionesnominaliquidaciones->parafiscales[$i][$parafisales-1])+($tblD[$i][$columnasTblD-1])).'</td>
	           <td align="right" style="border-top:1px solid;padding:3px 3px;border-color:#000">'.number_format(($Primavacacionesnominaliquidaciones->liquidacion[$i][$columnas-1])-(($Primavacacionesnominaliquidaciones->parafiscales[$i][$parafisales-1])+($tblD[$i][$columnasTblD-1]))).'</td>
	          </tr>
	 ...
	 if($sw=='sendmail'){
	  ...
	  $mail->Subject = "Nomina electronica Uniguajira No ".$Primavacacionesnominaliquidaciones->liquidacion[$i][13].' - '.$Primavacacionesnominaliquidaciones->liquidacion[$i][1].'. Empleado:'.number_format($Mensualnomina->Personageneral->PEGE_IDENTIFICACION);
	  ...
	  if(!$send)
	   {
	    $tabla2.=" 
	    <td>".$Primavacacionesnominaliquidaciones->liquidacion[$i][13]." - ".$Primavacacionesnominaliquidaciones->liquidacion[$i][1]."</td>
	    <td>".$Mensualnomina->Personageneral->PEGE_IDENTIFICACION."</td>
	    <td>".$Mensualnomina->Personageneral->PEGE_EMAIL." </td>
	    <td align='center'>".CHtml::image(Yii::app()->request->baseUrl . '/images/email_error.png')."<br>No enviado</td>
