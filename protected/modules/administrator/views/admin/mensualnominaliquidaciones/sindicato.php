...
?>         
             ...
             <td width="10%" align="center">
					 ...
					 $htmlOptions = array('class' => 'thumbnail','rel' => 'tooltip','data-title' => 'Reporte Liquidacion de Sindicatos');
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/mensualnominaliquidaciones/downsindicato',
