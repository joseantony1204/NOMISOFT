...
if($sw==1){
   ...
   $url = array('admin/mensualnominaliquidaciones/planoPorUnidades','mensualNomina'=>$mensualNomina,);
 }elseif($sw==''){
         $img = '/images/icon_download_txt.png';
         $htmlOption = 'Descargar Archivo Plano';
         $url = array('admin/mensualnominaliquidaciones/planoGeneral',
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
			 ...
			 <td width="60%"><strong><span><em>DETALLES DE LIQUIDACION NOMINA MENSUAL ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
             ...
             if($sw==NULL){		 
			 $img = '/images/icon_download_unidades.png';
			 $htmlOption = 'Descargar Archivo Plano Completo';
			 $url = array('admin/mensualnominaliquidaciones/planoGeneral',
			                                                          'mensualNomina'=>$mensualNomina,
																	  'mensualNomina2'=>$mensualNomina2,
																	  'personaGral'=>$personaGral,
			 ...
			 $image = CHtml::image($imageUrl);
			 echo CHtml::link($image, array('admin/mensualnominaliquidaciones/planogeneralpdf',
			                                                                          'mensualNomina'=>$mensualNomina,
																	                  'mensualNomina2'=>$mensualNomina2,
																					  'personaGral'=>$personaGral,
																					  'unidad'=>$unidad,
...
//echo $Mensualnominaliquidaciones->parafiscales[1][$parafisales-1].' - '.$tblD[1][$columnasTblD-1];
         ...
         <td width="45%">
			...
			<table width="100%" border="1" class="tabla2">
			 ...
			 <tr>
			  ...
			  <tr>
               <td>Puntos</td>
               <td><?php echo $Mensualnominaliquidaciones->liquidacion[$i][3]; ?> </td>
      	      </tr>
