       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE NOVEDADESMENSUALES  [ Actualizar ] </em></span></strong></td>
...
?>         
             ...
             <td width="13%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/novedadesmensuales/update','id'=>$model->NOME_ID),$htmlOptions ); 
?>        
					              </td>
           </tr>
        </table>
