 ...
 return 1;
	...
	function detalles(f){
	 if(validar(f)==1){
		...
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/detalles/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01/unidad/"+unidad+"/personaGral/"+identificacion+"/tipoEmpleo/"+tipoEmpleado);
	  }
	}
	...
	function resumen(f){
	 if(validar(f)==1){
		...
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/resumen/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01/unidad/"+unidad+"/personaGral/"+identificacion+"/tipoEmpleo/"+tipoEmpleado);
	  }
	}
	...
	function email(f){
	 if(validar(f)==1){
		...
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/email/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01/unidad/"+unidad+"/personaGral/"+identificacion+"/tipoEmpleo/"+tipoEmpleado);
	  }
	}
	...
	function salud(f){
	 if(validar(f)==1){
		...
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/salud/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01/unidad/"+unidad+"/personaGral/"+identificacion+"/tipoEmpleo/"+tipoEmpleado+"/idSalud/"+idSalud);
	  }
	 }
	 ...
	 if(validar(f)==1){
		...
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/pension/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01/unidad/"+unidad+"/personaGral/"+identificacion+"/tipoEmpleo/"+tipoEmpleado+"/idPension/"+idPension);
	  }
	}
	...
	function sindicato(f){
	 if(validar(f)==1){
		...
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/sindicato/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01/unidad/"+unidad+"/personaGral/"+identificacion+"/tipoEmpleo/"+tipoEmpleado+"/idSindicato/"+idSindicato);
	  }
	}
		...
		if((idDescuento)!=''){
		 if((idDescuento)==null){
          alert('Debe seleccionar algun descuento de la lista..!');
		      ...
		      window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/descuento/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01/unidad/"+unidad+"/personaGral/"+identificacion+"/tipoEmpleo/"+tipoEmpleado+"/idDescuento/"+idDescuento);
	         }		 
		}
	 }
	}
	...
	function retefuente(f){
	 if(validar(f)==1){
		...
		var mesInicial = $("#Informes_INFO_MESINICIO").val();
		var mesFinal = $("#Informes_INFO_MESFINAL").val();		
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/retefuente/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01");
	  }
	}
	...
	function estampilla(f){
	 if(validar(f)==1){
		...
		var mesInicial = $("#Informes_INFO_MESINICIO").val();
		var mesFinal = $("#Informes_INFO_MESFINAL").val();		
		window.location=("/NOMINA/administrator/admin/mensualnominaliquidaciones/estampilla/mensualNomina/"+anioInicial+mesInicial+"01/mensualNomina2/"+anioFinal+mesFinal+"01");
	  }
	}
</script>
