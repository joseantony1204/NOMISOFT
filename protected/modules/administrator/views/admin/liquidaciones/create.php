       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE LIQUIDACIONES FINALES [ Nuevo ] </em></span></strong></td>
...
?>         
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Liquidaciones'=>$Liquidaciones)); ?></p></td>
  </tr>
</table>
