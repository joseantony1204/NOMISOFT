  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		PRIMASTECNICAS  : Editar ] </strong></td>
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('primastecnicas/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('primastecnicas/update','id'=>$model->PRTE_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
