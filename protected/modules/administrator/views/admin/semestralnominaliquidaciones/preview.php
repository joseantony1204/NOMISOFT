...
$this->breadcrumbs=array(
	'Prima semestral'=>Yii::app()->request->urlReferrer,
	'Detalles'
);
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
			 ...
			 <td width="80%"><strong><span><em>DETALLES LIQUIDACION DE PRIMA SEMESTARL ( <?php echo $Semestralnominaliquidaciones->SENO_PERIODO; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
...
$Semestralnomina->SENO_PERIODO = $Semestralnominaliquidaciones->SENO_PERIODO;
		    ...
		    <table width="100%" border="0" class="tabla2" style="border:1px solid;padding:3px 3px; border-color:#000">
			 ...
			 <?php
	          ...
	          <tr>
	           ...
	           <td align='right' style='border-top:1px solid;padding:3px 3px;border-color:#000'><?php echo number_format($Semestralnominaliquidaciones->liquidacion[$i][$columnas-2]); ?></td>
	           ...
	           <td align='right' style='border-top:1px solid;padding:3px 3px;border-color:#000'><?php echo number_format(($Semestralnominaliquidaciones->liquidacion[$i][$columnas-2])-(($Semestralnominaliquidaciones->parafiscales[$i][$parafisales-1])+($tblD[$i][$columnasTblD-1]))); ?></td>
	          </tr>
