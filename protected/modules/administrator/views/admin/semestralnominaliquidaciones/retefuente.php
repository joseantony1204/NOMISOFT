...
$this->breadcrumbs=array(
	...
	'Busqueda'=>array('admin/semestralnomina/search'),
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="84%"><strong><span><em>ADMINISTRACION DE PRIMA SEMESTRAL - REPORTE TERCEROS : ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
...
?>         
             ...
             <td width="10%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/semestralnominaliquidaciones/downretefuente',
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'dataProvider'=>$Semestralnominaliquidaciones->prestacionesDataProvider,
