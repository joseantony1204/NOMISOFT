...
foreach($unidades as $unidad){
 ...
 chr(195).$arc->lineaH($c1).chr(179).$arc->lineaH($c2).chr(179).$arc->lineaH($c3).chr(179).$arc->lineaH($c4).chr(179).$arc->lineaH($c5).chr(179).$arc->lineaH($c6).chr(179).$arc->lineaH($c7).chr(180).$arc->enter();
 $pagina=1;
 ...
 for($i=1;$i<$filas-1;$i++){ 
  ...
  if($neto!=0){
	...
	$basico=NULL;
	$basico[0]=$arc->espacio($c1).chr(179).$arc->izquierda("Comprobante No. ".$Semestralnominaliquidaciones->liquidacion[$i][11].'-'.$Semestralnominaliquidaciones->liquidacion[$i][1],$c2);
	$basico[1]=$arc->espacio($c1).chr(179).$arc->izquierda(trim($Semestralnomina->SENO_PERIODO), $c2);
	...
	$pago=NULL;
	$pago[0]=$arc->izquierda("SUELDO (".number_format($Mensualnomina->Empleoplanta->EMPL_SUELDO).")",$c3).chr(179).$arc->centro($Semestralnominaliquidaciones->liquidacion[$i][2],$c4).chr(179).$arc->derecha(number_format($Semestralnominaliquidaciones->liquidacion[$i][4]),$c5).chr(179).$arc->espacio($c6).chr(179).$arc->espacio($c7);
	$lineapago=1;
		...
		for ($ln=5;$ln<11;$ln++){
		  if ($Semestralnominaliquidaciones->liquidacion[$i][$ln]!=0){
		   ...
		   $pago[$lineapago]=$arc->izquierda($Semestralnominaliquidaciones->liquidacion[0][$ln],$c3).chr(179).$arc->centro($antig,$c4).chr(179).$arc->derecha(number_format($Semestralnominaliquidaciones->liquidacion[$i][$ln]),$c5).chr(179).$arc->espacio($c6).chr(179).$arc->espacio($c7);
		   $lineapago++;
		  }
		}
		...
		for ($ln=1;$ln<2;$ln++){
			if ($Semestralnominaliquidaciones->parafiscales[$i][$ln]!=0){
				$pago[$lineapago]=$arc->izquierda($Semestralnominaliquidaciones->parafiscales[0][$ln],$c3).chr(179).$arc->espacio($c4).chr(179).$arc->espacio($c5).chr(179).$arc->derecha(number_format($Semestralnominaliquidaciones->parafiscales[$i][$ln]),$c6).chr(179).$arc->espacio($c7);
				$lineapago++;
			}
		}
		...
		$pago[$lineapago].=$arc->derecha(number_format($Semestralnominaliquidaciones->liquidacion[$i][$columnas-1]),$c5).chr(179);
		$pago[$lineapago].=$arc->derecha(number_format(($Semestralnominaliquidaciones->parafiscales[$i][$parafisales-1])+($tblD[$i][$columnasTblD-1])),$c6).chr(179);
