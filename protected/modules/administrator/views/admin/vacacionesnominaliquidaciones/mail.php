...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('vacacionesnominaliquidaciones-grid', {
		data: $(this).serialize()
	});
	return false;
});
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
			 ...
			 <td width="70%"><strong><span><em>ENVIAR POR CORREO DE LIQUIDACION DE VACACIONES ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
		     ...
		     echo CHtml::link($image, array('admin/vacacionesnomina/search',                                                              
										   ),
							 $htmlOptions 
							);
			?>           
			 ...
			 $image = CHtml::image($imageUrl);
		     echo CHtml::link($image, array('admin/vacacionesnominaliquidaciones/mail',
...
?>
	...
	if ($Mensualnomina->Personageneral->PEGE_EMAIL=='' or !$Mensualnomina->Personageneral->PEGE_EMAIL){
       $tabla2.=" 
       <td>".$Vacacionesnominaliquidaciones->liquidacion[$i][14]."</td>
	 ...
	 if ($Vacacionesnomina->VANO_ESTADO==0)
		$estado='<strong><font color="#FF0000">Estado:&nbsp;&nbsp;&nbsp;En revisión</font></strong>';
	 elseif($Vacacionesnomina->VANO_ESTADO==1)
        ...
        <tr valign="top">
         <td width="45%">
			...
			<table width="100%" rules="all" border="1" class="tabla2">
			  ...
			  <tr>
                ...
                <td width="181">'.$Vacacionesnominaliquidaciones->liquidacion[$i][13].' - '.$Vacacionesnominaliquidaciones->liquidacion[$i][1].'</td>
              </tr>
             
			 <tr>
                <td width="87">Periodo Liquidación</td>
                <td width="181">'.$Vacacionesnomina->VANO_PERIODO.'</td>
              </tr>
         ...
         <td width="55%" >
		    ...
		    <table width="100%" border="1" class="tabla2" rules="cols">
              ...
              <tr>
	           <td>SUELDO('.number_format($Vacacionesnominaliquidaciones->liquidacion[$i][4]).')</td>
			   <td align="center">'.$Vacacionesnominaliquidaciones->liquidacion[$i][2].'</td>
			   <td align="right">'.number_format($Vacacionesnominaliquidaciones->liquidacion[$i][5]).'</td>
	           <td>&nbsp;</td>
	           <td>&nbsp;</td>		       
		      </tr>';
			  ...
			  $tabla1 .='
	          <tr>
		       <td>'.$Vacacionesnominaliquidaciones->liquidacion[0][$ln].'</td>
		       <td align="center">'.$antig.'</td>
		       <td align="right">'.number_format($Vacacionesnominaliquidaciones->liquidacion[$i][$ln]).'</td>
		       <td>&nbsp;</td>
		       <td>&nbsp;</td>		       
		      </tr>';
			  ...
			  $tabla1.='
			  <tr>
		       <td>'.$Vacacionesnominaliquidaciones->parafiscales[0][$ln].'</td>
		       <td align="center">&nbsp;</td>
		       <td>&nbsp;</td>
			   <td align="right">'.number_format($Vacacionesnominaliquidaciones->parafiscales[$i][$ln]).'</td>
		       <td>&nbsp;</td>		       
		      </tr>';
	          ...
	          <tr>
	           ...
	           <td align="right" style="border-top:1px solid;padding:3px 3px;border-color:#000">'.number_format($Vacacionesnominaliquidaciones->liquidacion[$i][$columnas-1]).'</td>
	           <td align="right" style="border-top:1px solid;padding:3px 3px;border-color:#000">'.number_format(($Vacacionesnominaliquidaciones->parafiscales[$i][$parafisales-1])+($tblD[$i][$columnasTblD-1])).'</td>
	           <td align="right" style="border-top:1px solid;padding:3px 3px;border-color:#000">'.number_format(($Vacacionesnominaliquidaciones->liquidacion[$i][$columnas-1])-(($Vacacionesnominaliquidaciones->parafiscales[$i][$parafisales-1])+($tblD[$i][$columnasTblD-1]))).'</td>
	          </tr>
	 ...
	 if($sw=='sendmail'){
	  ...
	  $mail->Subject = "Nomina electronica Uniguajira No ".$Vacacionesnominaliquidaciones->liquidacion[$i][13].' - '.$Vacacionesnominaliquidaciones->liquidacion[$i][1].'. Empleado:'.number_format($Mensualnomina->Personageneral->PEGE_IDENTIFICACION);
	  ...
	  if(!$send)
	   {
	    $tabla2.=" 
	    <td>".$Vacacionesnominaliquidaciones->liquidacion[$i][13]." - ".$Vacacionesnominaliquidaciones->liquidacion[$i][1]."</td>
	    <td>".$Mensualnomina->Personageneral->PEGE_IDENTIFICACION."</td>
	    <td>".$Mensualnomina->Personageneral->PEGE_EMAIL." </td>
	    <td align='center'>".CHtml::image(Yii::app()->request->baseUrl . '/images/email_error.png')."<br>No enviado</td>
