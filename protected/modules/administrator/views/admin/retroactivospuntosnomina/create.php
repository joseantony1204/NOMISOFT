       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE RETROACTIVOS PUNTOS NOMINA  [ Nuevo ] </em></span></strong></td>
...
?>         
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Retroactivospuntosnomina'=>$Retroactivospuntosnomina)); ?></p></td>
  </tr>
</table>
