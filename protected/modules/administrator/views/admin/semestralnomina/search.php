...
$this->breadcrumbs=array(
	'Prima Semestral'=>array('admin/semestralnomina/search'),
	'Busqueda Avanzada',
);
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE REPORTES DE PRIMA SEMESTRAL [ Busqueda Avanzada ] </em></span></strong></td>
			...
			<tr>
			 ...
			 <table width="100%" border="0" align="center">            
			  ...
			  <tr>
		       ...
		       $criterio ->select = '"SENO_ANIO"';
		       $criterio->group = '"SENO_ANIO"'; 
			   $criterio->order = '"SENO_ANIO" DESC';    
		       $anios = CHtml::listData(Semestralnomina::model()->findAll($criterio),'SENO_ANIO','SENO_ANIO');
		       ?>	      
