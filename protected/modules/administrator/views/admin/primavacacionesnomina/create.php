       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE PRIMA DE VACACIONES  [ Crear liquidacion periodo ] </em></span></strong></td>
...
?>         
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Primavacacionesnomina'=>$Primavacacionesnomina)); ?></p></td>
  </tr>
</table>
