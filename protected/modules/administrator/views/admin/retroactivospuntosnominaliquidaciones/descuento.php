...
$this->breadcrumbs=array(
	'Nomina Retroactivo'=>array('admin/retroactivosnominaliquidaciones/admin'),
	'Busqueda'=>array('admin/retroactivosnominaliquidaciones/search'),
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="84%"><strong><span><em>ADMINISTRACION DE NOMINA RETROACTIVO - REPORTE TERCEROS : ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
...
?>         
             ...
             <td width="10%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/retroactivosnominaliquidaciones/downdescuento',
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'dataProvider'=>$Retroactivosnominaliquidaciones->prestacionesDataProvider,
