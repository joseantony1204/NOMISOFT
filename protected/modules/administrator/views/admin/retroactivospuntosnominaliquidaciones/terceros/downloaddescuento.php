<?php
$filas = count($Retroactivosnominaliquidaciones->prestaciones);
$columnas = count($Retroactivosnominaliquidaciones->prestaciones[1]);
 ...
 $lista = NULL; $index=0;
 for($i=1;$i<$filas;$i++){		 
  $nombre = trim($Retroactivosnominaliquidaciones->prestaciones[$i][3]).$arc->espacio(1).trim($Retroactivosnominaliquidaciones->prestaciones[$i][4]).$arc->espacio(1).trim($Retroactivosnominaliquidaciones->prestaciones[$i][5]).$arc->espacio(1).trim($Retroactivosnominaliquidaciones->prestaciones[$i][6]);				 
  $lista[$index]=$arc->centro(number_format($Retroactivosnominaliquidaciones->prestaciones[$i][2]),$c1).$arc->centro($nombre,$c2).$arc->centro(trim($Retroactivosnominaliquidaciones->prestaciones[$i][7]),$c3).$arc->derecha(number_format($Retroactivosnominaliquidaciones->prestaciones[$i][8]),$c4);
  
  $total4=$total4+$Retroactivosnominaliquidaciones->prestaciones[$i][8]; // total
  $index++;  
 }
