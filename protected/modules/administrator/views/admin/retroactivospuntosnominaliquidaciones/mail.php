...
$this->breadcrumbs=array(
	'Nomina Retroactivos Puntos'=>array('admin/retroactivopuntosnomina/admin'),
	'Enviar Email'
);
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
			 ...
			 <td width="70%"><strong><span><em>ENVIAR POR EMAIL LIQUIDACION DE RETROACTIVOS DE PUNTOS ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
		     ...
		     echo CHtml::link($image, array('admin/retroactivospuntosnominaliquidaciones/totales',
...
$columnas = count($Retroactivospuntosnominaliquidaciones->retroactivogeneral[$filas-1]);
...
?>
	...
	if ($Mensualnomina->Personageneral->PEGE_EMAIL=='' or !$Mensualnomina->Personageneral->PEGE_EMAIL){
       $tabla2.=" 
       <td>".$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][12]."</td>
	 ...
	 if ($Retroactivospuntosnomina->RPNO_ESTADO==0)
		$estado='<strong><font color="#FF0000">Estado:&nbsp;&nbsp;&nbsp;En revisión</font></strong>';
	 elseif($Retroactivospuntosnomina->RPNO_ESTADO==1)
	 ...
	 <table width="100%" border="1" align="center" CELLSPACING="0" class="tabla2" >
        <tr>
         <th colspan="2" align="center">RETROACTIVOS DE PUNTOS DE EMPLEADOS UNIVERSIDAD DE LA GUAJIRA</th>
        </tr>
        <tr>
         ...
         <td width="45%">
			...
			<table width="100%" border="1" CELLSPACING="0" class="tabla2">
			  ...
			  <tr>
                ...
                <td width="181">'.$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][12].' - '.$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][1].'</td>
              </tr>
             
			 <tr>
                <td width="87">Periodo Liquidación</td>
                <td width="181">'.$Retroactivospuntosnomina->RPNO_PERIODO.'</td>
              </tr>
			  
			  <tr>
                <td width="87">Puntos Liquidados</td>
                <td width="181">'.$Retroactivospuntosnomina->RPNO_PUNTOS.'</td>
              </tr>
			 ...
			 <tr>
			  ...
			  <tr>
               <td>Puntos Antes</td>
               <td>'.($Mensualnomina->Empleoplanta->EMPL_PUNTOS-$Retroactivospuntosnomina->RPNO_PUNTOS).'</td>
      	      </tr>
         ...
         <td width="55%" >
		    ...
		    <table width="100%" border="0" class="tabla2" style="border:1px solid;padding:3px 3px; border-color:#000">
              ...
              <tr>
			   ...
			   <td align="center">'.$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][2].'</td>
			   <td align="right">'.number_format($devengado[4]).'</td>
	           <td>&nbsp;</td>
		       <td align="right">'.number_format($Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][4]).'</td>
		      </tr>';
			  ...
			  if ($ln==5){
		  		$antig = $Mensualnomina->Personageneral->getAntiguedad($Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][26])." A";
		  		}else{
					  $antig = "&nbsp;";
			         }
			  ...
			  $tabla1 .='
	          <tr>
		       <td>'.$Retroactivospuntosnominaliquidaciones->retroactivogeneral[0][$ln].'</td>
		       <td align="center">'.$antig.'</td>
		       <td align="right">'.number_format($devengado[$ln]).'</td>
		       <td>&nbsp;</td>
		       <td align="right">'.number_format($Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][$ln]).'</td>
		      </tr>';
	          ...
	          <tr>
	           ...
	           <td align="right" style="border-top:1px solid;padding:3px 3px;border-color:#000">'.number_format(($Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][$columnas-3])-($tblD[$i][$columnasTblD-1])).'</td>
	          </tr>
	 ...
	 if($sw=='sendmail'){
	  ...
	  $mail->Subject = "Nomina electronica Uniguajira No ".$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][12].' - '.$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][1].'. Empleado:'.number_format($Mensualnomina->Personageneral->PEGE_IDENTIFICACION);
	  ...
	  if(!$send)
	   {
	    $tabla2.=" 
	    <td>".$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][12]." - ".$Retroactivospuntosnominaliquidaciones->retroactivogeneral[$i][1]."</td>
	    <td>".$Mensualnomina->Personageneral->PEGE_IDENTIFICACION."</td>
	    <td>".$Mensualnomina->Personageneral->PEGE_EMAIL." </td>
	    <td align='center'>".CHtml::image(Yii::app()->request->baseUrl . '/images/email_error.png')."<br>No enviado</td>
