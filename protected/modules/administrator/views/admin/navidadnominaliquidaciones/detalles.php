...
$this->breadcrumbs=array(
	'Prima Semestral'=>array('admin/navidadnomina/admin'),
	'Detalles'
);
...
if($sw==1){
   ...
   $url = array('admin/navidadnominaliquidaciones/planoporunidades','navidadNomina'=>$navidadNomina,);
 }elseif($sw==''){
         $img = '/images/icon_download_txt.png';
         $htmlOption = 'Descargar Archivo Plano';
         $url = array('admin/navidadnominaliquidaciones/planogeneral',
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
			 ...
			 <td width="60%"><strong><span><em>DETALLES DE LIQUIDACION DE PRIMA DE NAVIDAD ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
			 ...
			 $image = CHtml::image($imageUrl);
			 echo CHtml::link($image, array('admin/navidadnominaliquidaciones/create',),$htmlOptions ); 
             ?>         
			 </td>
...
$columnas = count($Navidadnominaliquidaciones->liquidacion[$filas-1]);
        ...
        <tr valign="top">
         <td width="45%">
			...
			<table width="100%" border="1" class="tabla2">
			  ...
			  <tr>
                ...
                <td width="181"><?php echo $Navidadnominaliquidaciones->liquidacion[$i][14]; ?> - <?php echo $Navidadnominaliquidaciones->liquidacion[$i][1]; ?></td>
              </tr>
         ...
         <td width="55%" >
		    ...
		    <table width="100%" border="0" class="tabla2" style="border:1px solid;padding:3px 3px; border-color:#000">
              ...
              <tr>
	           <td>SUELDO(<?php echo number_format($Navidadnominaliquidaciones->liquidacion[$i][4]); ?>)</td>
		     ...
		     <?php
	          ...
	          <tr>
	           ...
	           <td align='right' style='border-top:1px solid;padding:3px 3px;border-color:#000'><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$i][$columnas-1]); ?></td>
	           ...
	           <td align='right' style='border-top:1px solid;padding:3px 3px;border-color:#000'><?php echo number_format(($Navidadnominaliquidaciones->liquidacion[$i][$columnas-1])-(($Navidadnominaliquidaciones->parafiscales[$i][$parafisales-1])+($tblD[$i][$columnasTblD-1]))); ?></td>
	          </tr>
