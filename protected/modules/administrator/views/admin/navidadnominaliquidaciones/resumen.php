...
$parafiscales = count($Navidadnominaliquidaciones->parafiscales[0]);
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="74%"><strong><span><em>RESUMEN DE LIQUIDACION PRIMA DE NAVIDAD ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
...
?>         
			 ...
			 <td width="10%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/navidadnominaliquidaciones/planoresumen',					                                                                              
      ...
      <tr>
        <td width="50%" valign="top">
		 ...
		 <table width="100%" border="1" class="tabla1">
          ...
          <tr>
            ...
            <td width="20%" align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][5]);?></td>
            <td width="17%" align="right">&nbsp;</td>
            <td width="18%" align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>GASTOS DE REPRESENTACION</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][10]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>SUBSIDIO DE TRANSPORTTE</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][7]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>PRIMA DE ANTIGUEDAD</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][6]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>PRIMA TECNICA</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][9]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>PRIMA DE ALIMENTACION</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][8]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>BONIFICACION SERV PRESTADOS</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][11]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
		  <tr>
            <td>PRIMA SEMESTRAL</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][12]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
		  <tr>
            <td>PRIMA VACACIONES</td>
            <td align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][13]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td align="right">&nbsp;</td>
            <th align="right"><?php echo number_format($Navidadnominaliquidaciones->liquidacion[$filas-1][16]);?></th>
            <td align="right">&nbsp;</td>
          </tr>
		  <tr>
            <td colspan='4'>&nbsp;</td>
		...
		<table width="100%" border="1" class="tabla1">
          ...
          <tr>
            ...
            ?>
            <td width="31%"><?php  echo number_format($Navidadnominaliquidaciones->parafiscales[$filas-1][1]); ?></td>
            <td width="34%">&nbsp;</td>
          </tr>
		  ...
		  <?php
		   $totalapr=round($var);
		   $var = $Navidadnominaliquidaciones->getInteresesCesantias($Navidadnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Navidadnominaliquidaciones->getPrimaNavidad($Navidadnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Navidadnominaliquidaciones->getPrimaVacaciones($Navidadnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Navidadnominaliquidaciones->getVacaciones($Navidadnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Navidadnominaliquidaciones->getPrimaSemestral($Navidadnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var=$Navidadnominaliquidaciones->getCajaCompensacion($baseicbf);
  		  ?>
		  <tr> 
