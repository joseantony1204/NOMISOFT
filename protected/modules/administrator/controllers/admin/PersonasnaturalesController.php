...
class PersonasnaturalesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Personasnaturales']))
		{
			$model->attributes=$_POST['Personasnaturales'];
	        $model->PENA_FECHACAMBIO =  date('Y-m-d H:i:s');
			$model->PENA_REGISTRADOPOR = Yii::app()->user->id;			 
			if($model->save())
				$this->redirect(array('admin','id'=>$model->PENA_ID));
		}
