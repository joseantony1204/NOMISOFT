...
class MensualnominaliquidacionesController extends Controller
{
	...
	public function actionTotales($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL)
	{
	...
	public function actionDetalles($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL,$sw=NULL)
	{
	...
	public function actionEmail($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL,$sw=NULL)
	{
		$Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$Email = new Email;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionPlanoPorUnidades($mensualNomina=NULL)
	{
		$Mensualnominaliquidaciones = new Mensualnominaliquidaciones;		 				
	...
	public function actionDownresumen($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL)
	{
		$Mensualnominaliquidaciones = new Mensualnominaliquidaciones;		
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionPlanoGeneral($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL,$sw=NULL)
	{
		$Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionPlanogeneralpdf($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL)
	{
		$Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionSalud($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idSalud=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionPension($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idPension=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionSindicato($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idSindicato=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionDescuento($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idDescuento=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionDownsalud($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idSalud=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionDownpension($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idPension=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionDownsindicato($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idSindicato=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	public function actionDowndescuento($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL, $idDescuento=NULL)
	{   
	    $Mensualnominaliquidaciones = new Mensualnominaliquidaciones;
		$lista = $this->setParametros($mensualNomina,$mensualNomina2,$personaGral,$unidad,$tipoEmpleo);
	...
	private function setParametros($mensualNomina=NULL,$mensualNomina2=NULL,$personaGral=NULL,$unidad=NULL,$tipoEmpleo=NULL)
	{
