				  ...
				  FROM ( 
						...
						FROM (
							   SELECT pg."PEGE_ID", ep."EMPL_ID", pg."PEGE_IDENTIFICACION", pg."PEGE_PRIMERNOMBRE", pg."PEGE_SEGUNDONOMBRE", pg."PEGE_PRIMERAPELLIDO", 
							    pg."PEGE_SEGUNDOAPELLIDOS", ep."EMPL_CARGO", ep."EMPL_SUELDO", 
							   (SELECT eep."ESEM_ID"
								 FROM "TBL_NOMESTADOSEMPLEOSPLANTA" eep 
							  ...
							  FROM "TBL_NOMPERSONASGENERALES" pg, "TBL_NOMEMPLEOSPLANTA" ep
							  WHERE pg."PEGE_ID" = ep."PEGE_ID" AND ep."TICA_ID" = 1 
							 ) g
	 ...
	 $sql=' 
			...
			FROM (
				  ...
				  FROM ( 
						...
						FROM (
							  SELECT pg."PEGE_ID", ep."EMPL_ID", pg."PEGE_IDENTIFICACION", pg."PEGE_PRIMERNOMBRE", pg."PEGE_SEGUNDONOMBRE", pg."PEGE_PRIMERAPELLIDO", 
							    pg."PEGE_SEGUNDOAPELLIDOS", ep."EMPL_CARGO", ep."EMPL_PUNTOS", ep."EMPL_SUELDO",
							   ( SELECT eep."ESEM_ID"
								 FROM "TBL_NOMESTADOSEMPLEOSPLANTA" eep 
							     WHERE ep."EMPL_ID" = eep."EMPL_ID" AND ep."PEGE_ID" = pg."PEGE_ID"
							     ORDER BY eep."ESEP_FECHAREGISTRO" DESC 
						      ...
						      FROM "TBL_NOMPERSONASGENERALES" pg, "TBL_NOMEMPLEOSPLANTA" ep
						      WHERE pg."PEGE_ID" = ep."PEGE_ID" AND ep."TICA_ID" = 2
							 ) g
