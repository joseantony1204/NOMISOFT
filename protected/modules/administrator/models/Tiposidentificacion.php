...
/**
 * Esta es la clase de modelo para la tabla "TBL_NOMTIPOSIDENTIFICACION".
 *
 * Las siguientes son las columnas disponibles en la tabla 'TBL_NOMTIPOSIDENTIFICACION':
...
class Tiposidentificacion extends CActiveRecord
{
	...
	{
		return 'TBL_NOMTIPOSIDENTIFICACION';
	}
