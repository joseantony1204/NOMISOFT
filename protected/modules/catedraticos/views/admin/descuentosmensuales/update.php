       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE DESCUENTOS MENSUALES  [ Actualizar ] </em></span></strong></td>
...
?>         
             ...
             <td width="13%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/descuentosmensuales/update','id'=>$model->DEME_ID),$htmlOptions ); 
?>        
					              </td>
           </tr>
        </table>
