      ...
      <tr>
        <td width="50%" valign="top">
		 ...
		 <table width="100%" border="1" class="tabla1">
          ...
          <tr>
            ...
            <td align="right">&nbsp;</td>
            <th align="right"><?php echo number_format($Mensualnominaliquidaciones->liquidacion[$filas-1][6]);?></th>
            <td align="right">&nbsp;</td>
          </tr>
		  <tr>
            <td colspan='4'>&nbsp;</td>
		...
		<table width="100%" border="1" class="tabla1">
          ...
          <tr>
			...
			<?php
		    $suma = 0;
			$suma = $Mensualnominaliquidaciones->parafiscales[$filas-1][8];
            ?>
            <td width="31%"><?php  echo number_format($Mensualnominaliquidaciones->parafiscales[$filas-1][8]); ?></td>
            <td width="34%">&nbsp;</td>
          </tr>
          <tr>
            <td width="35%" valign="top">ESTAMPILLA</td>
			<?php
		    $suma += $Mensualnominaliquidaciones->parafiscales[$filas-1][7];
            ?>
            <td width="31%"><?php  echo number_format($Mensualnominaliquidaciones->parafiscales[$filas-1][7]); ?></td>
            <td width="34%">&nbsp;</td>
          </tr>
		  <?php
		   for($i=1;$i<=$filasin;$i++) {
		  ...
		  <?php
		   $totalapr=round($var);
		   $var = $Mensualnominaliquidaciones->getInteresesCesantias($Mensualnominaliquidaciones->liquidacion[$filas-1][$columnas-2]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Mensualnominaliquidaciones->getPrimaNavidad($Mensualnominaliquidaciones->liquidacion[$filas-1][$columnas-2]);
  		  ?>
		  <tr> 
