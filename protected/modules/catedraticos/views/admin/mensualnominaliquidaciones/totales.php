       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="64%"><strong><span><em>TOTALES DE LIQUIDACION NOMINA MENSUAL ( <?php echo $Mensualnomina->MENO_PERIODO; ?> )</em></span></strong></td>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array('name'=>'MENL_HORASAPAGAR', 'type'=>'number', 'value'=>'$data->MENL_HORASAPAGAR', 'htmlOptions'=>array('width'=>'10','style'=>'text-align: center',),),
		array('name'=>'MENL_VALORHORA', 'filter'=>false, 'type'=>'number', 'value'=>'$data->MENL_VALORHORA', 'htmlOptions'=>array('width'=>'10','style'=>'text-align: right',),),
