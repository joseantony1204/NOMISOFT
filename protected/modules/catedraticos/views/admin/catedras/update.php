...
<table width="70%" border="0" align="left" class="">
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE CATEDRAS [ Actualizar Por Facultad ] </em></span></strong></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_update', array('Catedras'=>$Catedras)); ?></p></td>
  </tr>
</table>