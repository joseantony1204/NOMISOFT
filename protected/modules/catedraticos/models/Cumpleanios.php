...
class Cumpleanios extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->select = 't.*, p.*';
		$criteria->join = 'INNER JOIN "TBL_CATPERSONASGENERALES" "p" ON p."PEGE_ID" = t."PEGE_ID"';
	...
	public function getCumpleaniostoday(){
     ...
     $string = 'SELECT * FROM (
                ...
                FROM "TBL_CATCUMPLEANIOS" "t" INNER JOIN "TBL_CATPERSONASGENERALES" "p" ON p."PEGE_ID" = t."PEGE_ID" 
