...
class PeriodosacademicosController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Periodosacademicos']))
		{
	        ...
	        $model->PEAC_FECHACAMBIO =  date('Y-m-d H:i:s');
			$model->PEAC_REGISTRADOPOR = Yii::app()->user->id;			 
			if($model->save())
				$this->redirect(array('admin','id'=>$model->PEAC_ID));
		}
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='periodosacademicos-form')
		{
