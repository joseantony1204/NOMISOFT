...
/*
$this->menu=array(
	array('label'=>'List Semestralnominaliquidaciones','url'=>array('index')),
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="64%"><strong><span><em>ADMINISTRACION DE SEMESTRALNOMINALIQUIDACIONES</em></span></strong></td>
