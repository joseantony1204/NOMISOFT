...
$columnas = count($Navidadnominaliquidaciones->prestaciones[1]);
 ...
 for($i=1;$i<$filas;$i++){		 
  ...
  $lista[$index]=$arc->centro(number_format($Navidadnominaliquidaciones->prestaciones[$i][2]),$c1).$arc->centro($nombre,$c2).$arc->derecha(number_format($Navidadnominaliquidaciones->prestaciones[$i][7]),$c3);
  
  $total4=$total4+$Navidadnominaliquidaciones->prestaciones[$i][7]; // total
  $index++;  
 }
