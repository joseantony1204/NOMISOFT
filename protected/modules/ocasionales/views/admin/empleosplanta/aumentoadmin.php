...
$this->breadcrumbs=array(
	'Actualizar sueldo administrativos'=>array('admin/empleosplanta/aumentoadmin',),
	'Administrar',
);
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="74%"><strong><span><em>AUMENTO DE SUELDO PARA EMPLEADOS ADMINISTRATIVOS</em></span></strong></td>
...
?>         
             ...
             <td width="10%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/empleosplanta/aumentoadmin',),$htmlOptions ); 
?>         
					              </td>
           </tr>
        </table>
  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0">
       <tr>
        <td width="65%" align="right"><div class="tab"><strong>Porcentaje Aumento Salarial</strong> :</div></td>
