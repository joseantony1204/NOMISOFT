       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE PRIMA SEMESTRAL  [ Crear liquidacion periodo ] </em></span></strong></td>
...
?>         
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Semestralnomina'=>$Semestralnomina)); ?></p></td>
  </tr>
</table>
