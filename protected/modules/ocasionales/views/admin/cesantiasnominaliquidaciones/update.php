       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE CESANTIASNOMINALIQUIDACIONES  [ Actualizar ] </em></span></strong></td>
...
?>         
             ...
             <td width="13%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/cesantiasnominaliquidaciones/update','id'=>$model->CENL_ID),$htmlOptions ); 
?>        
					              </td>
           </tr>
        </table>
