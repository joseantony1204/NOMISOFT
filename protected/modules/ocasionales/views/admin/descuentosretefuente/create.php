...
$this->breadcrumbs=array(
	...
	'Ingresar Descuentos Retefuente',
);
?>
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE DESCUENTOS RETEFUENTE  [ Ingresar Descuentos Retefuente ] </em></span></strong></td>
...
?>         
             ...
             <td width="13%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/descuentosretefuente/create','id'=>$Personasgenerales->PEGE_ID),$htmlOptions ); 
?>         
					              </td>
           </tr>
        </table>
