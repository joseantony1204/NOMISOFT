...
$parafiscales = count($Recreacionnominaliquidaciones->parafiscales[0]);
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="74%"><strong><span><em>RESUMEN DE LIQUIDACION NOMINA DE RECREACION ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
...
?>         
			 ...
			 <td width="10%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/recreacionnominaliquidaciones/planoresumen',					                                                                              
      ...
      <tr>
        <td width="50%" valign="top">
		 ...
		 <table width="100%" border="1" class="tabla1">
          ...
          <tr>
            ...
            <td width="20%" align="right"><?php echo number_format($Recreacionnominaliquidaciones->liquidacion[$filas-1][5]);?></td>
          ...
          <tr>
            ...
            <td align="right">&nbsp;</td>
            <th align="right"><?php echo number_format($Recreacionnominaliquidaciones->liquidacion[$filas-1][8]);?></th>
            <td align="right">&nbsp;</td>
          </tr>
		  <tr>
            <td colspan='4'>&nbsp;</td>
		...
		<table width="100%" border="1" class="tabla1">
          ...
          <tr>
            ...
            ?>
            <td width="31%"><?php  echo number_format($Recreacionnominaliquidaciones->parafiscales[$filas-1][1]); ?></td>
            <td width="34%">&nbsp;</td>
          </tr>
		  ...
		  <?php
		   $totalapr=round($var);
		   $var = $Recreacionnominaliquidaciones->getInteresesCesantias($Recreacionnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Recreacionnominaliquidaciones->getPrimaNavidad($Recreacionnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Recreacionnominaliquidaciones->getPrimaVacaciones($Recreacionnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Recreacionnominaliquidaciones->getVacaciones($Recreacionnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Recreacionnominaliquidaciones->getPrimaSemestral($Recreacionnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var=$Recreacionnominaliquidaciones->getCajaCompensacion($baseicbf);
  		  ?>
		  <tr> 
