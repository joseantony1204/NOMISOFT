...
<table width="82%" border="0" align="left" class="">
  <tr>
   <td>
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="63%"><strong><span><em>ADMINISTRACION DE DESCUENTOS PRESTACIONES (<?php echo $Tiposprestaciones->TIPR_NOMBRE; ?>) [ Actualizar ] </em></span></strong></td>
...
?>         
             ...
             <td width="13%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/descuentosprestaciones/update','id'=>$model->DEPR_ID),$htmlOptions ); 
?>        
					              </td>
           </tr>
        </table>
