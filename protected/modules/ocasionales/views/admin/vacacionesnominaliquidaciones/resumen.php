...
$parafiscales = count($Vacacionesnominaliquidaciones->parafiscales[0]);
       ...
       <fieldset>
        <table width="100%" border="0" align="center">
            <tr>
             ...
             <td width="74%"><strong><span><em>RESUMEN DE LIQUIDACION DE VACACIONES ( <?php echo $Periodo; ?> )<br><?php echo $tercero; ?></em></span></strong></td>
...
?>         
			 ...
			 <td width="10%" align="center">
					 ...
					 $image = CHtml::image($imageUrl);
					 echo CHtml::link($image, array('admin/vacacionesnominaliquidaciones/planoresumen',					                                                                              
      ...
      <tr>
        <td width="50%" valign="top">
		 ...
		 <table width="100%" border="1" class="tabla1">
          ...
          <tr>
            ...
            <td width="20%" align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][5]);?></td>
            <td width="17%" align="right">&nbsp;</td>
            <td width="18%" align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>GASTOS DE REPRESENTACION</td>
            <td align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][10]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>SUBSIDIO DE TRANSPORTTE</td>
            <td align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][7]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>PRIMA DE ANTIGUEDAD</td>
            <td align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][6]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>PRIMA TECNICA</td>
            <td align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][9]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>PRIMA DE ALIMENTACION</td>
            <td align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][8]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            <td>BONIFICACION SERV PRESTADOS</td>
            <td align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][11]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
		  <tr>
            <td>PRIMA SEMESTRAL</td>
            <td align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][12]);?></td>
            <td align="right">&nbsp;</td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td align="right">&nbsp;</td>
            <th align="right"><?php echo number_format($Vacacionesnominaliquidaciones->liquidacion[$filas-1][15]);?></th>
            <td align="right">&nbsp;</td>
          </tr>
		  <tr>
            <td colspan='4'>&nbsp;</td>
		...
		<table width="100%" border="1" class="tabla1">
          ...
          <tr>
            ...
            ?>
            <td width="31%"><?php  echo number_format($Vacacionesnominaliquidaciones->parafiscales[$filas-1][1]); ?></td>
            <td width="34%">&nbsp;</td>
          </tr>
		  ...
		  <?php
		   $totalapr=round($var);
		   $var = $Vacacionesnominaliquidaciones->getInteresesCesantias($Vacacionesnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Vacacionesnominaliquidaciones->getPrimaNavidad($Vacacionesnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Vacacionesnominaliquidaciones->getPrimaVacaciones($Vacacionesnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Vacacionesnominaliquidaciones->getVacaciones($Vacacionesnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var = $Vacacionesnominaliquidaciones->getPrimaSemestral($Vacacionesnominaliquidaciones->liquidacion[$filas-1][$columnas-1]);
  		  ?>
		  <tr> 
		  ...
		  <?php
		   $totalapr+=round($var);
		   $var=$Vacacionesnominaliquidaciones->getCajaCompensacion($baseicbf);
  		  ?>
		  <tr> 
