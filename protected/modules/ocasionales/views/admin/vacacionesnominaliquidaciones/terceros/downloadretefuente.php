...
$columnas = count($Vacacionesnominaliquidaciones->prestaciones[1]);
 ...
 for($i=1;$i<$filas;$i++){		 
  ...
  $lista[$index]=$arc->centro(number_format($Vacacionesnominaliquidaciones->prestaciones[$i][2]),$c1).$arc->centro($nombre,$c2).$arc->derecha(number_format($Vacacionesnominaliquidaciones->prestaciones[$i][7]),$c3);
  
  $total4=$total4+$Vacacionesnominaliquidaciones->prestaciones[$i][7]; // total
  $index++;  
 }
