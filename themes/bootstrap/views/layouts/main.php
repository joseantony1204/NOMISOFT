            ...
            'items'=>array(
				...
				*/
				 array('label'=>'GENERALIDADES', 'icon'=>'th', 'url'=>array('#',), 'visible'=>!Yii::app()->user->isGuest&&Yii::app()->user->getState('module')==1, 'items'=>array(
                    ...
                    array('label'=>'Retroactivo Salarial',  'url'=>array('/administrator/admin/descuentosprestaciones/admin','id'=>5), 'visible'=>!Yii::app()->user->isGuest,),
                    array('label'=>'Retroactivo Puntos',  'url'=>array('/administrator/admin/descuentosprestaciones/admin','id'=>6), 'visible'=>!Yii::app()->user->isGuest,),
				...
				*/
				array('label'=>'NOVEDADES', 'icon'=>'tags', 'url'=>array('#',), 'visible'=>!Yii::app()->user->isGuest&&Yii::app()->user->getState('module')==1, 'items'=>array(                   
                    ...
                    array('label'=>'Retroactivo Salarial',  'url'=>array('/administrator/admin/novedadesprestaciones/search','id'=>5), 'visible'=>!Yii::app()->user->isGuest,),
                    array('label'=>'Retroactivo Puntos',  'url'=>array('/administrator/admin/novedadesprestaciones/search','id'=>6), 'visible'=>!Yii::app()->user->isGuest,),
				...
				*/
				array('label'=>'NÓMINAS', 'icon'=>'list-alt', 'url'=>array('#',), 'visible'=>!Yii::app()->user->isGuest&&Yii::app()->user->getState('module')==1, 'items'=>array(
                    ...
                    array('label'=>'Retroactivo Puntos',  'url'=>array('/administrator/admin/retroactivospuntosnomina/admin',), 'visible'=>!Yii::app()->user->isGuest,),
